    ...
    if (!venues || venues.length === 0) {
        return (
            <div className="text-sm text-center text-gray-500">
                Belum ada tempat olahraga (venue) yang ditambahkan.
            </div>
        );
    }
                    ...
                    {venues.slice(0, 6).map((venue) => (
                        ...
                        >
                            <img
                                src={
                                    venue.image ||
                                    "/assets/images/venue-default.jpg"
                                }
                                alt={venue.name}
                            ...
                            <div className="absolute top-0 left-0 right-0 p-3 z-10 flex items-start justify-between">
                                <div className="flex flex-col gap-1">
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {venue.categories?.map((cat, index) => {
                                            const catAttr = getCategoryBadge(
                                                cat.name,
                                            );
                                            return (
                                                <Badge
