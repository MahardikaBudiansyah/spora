                ...
                <form>
                    ...
                    <CardBody>
                        ...
                        {cartItems.map((venueGroup) => {
                            // Cek slot terpilih untuk venue ini
                            ...
                            return (
                                <div key={venueGroup.venue.id} className="mb-4">
                                    ...
                                    {venueGroup.fields.map((fieldGroup) => (
                                        <div
                                            key={fieldGroup.field.id}
                                            className="mb-3"
                                        >
                                            <h3 className="text-sm font-semibold dark:text-gray-300 mb-1">
                                                {fieldGroup.field.name}
                                            </h3>

                                            {fieldGroup.dates.map(
                                                (dateGroup) => (
                                                    <div
                                                        key={dateGroup.date}
                                                        className="mb-2"
                                                    >
                                                        <h4 className="italic dark:text-gray-400 mb-1">
                                                            {dateGroup.date}
                                                        </h4>
