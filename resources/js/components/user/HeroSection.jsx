...
export default function HeroSection() {
    return (
        <section className="bg-center bg-cover bg-no-repeat bg-[url('/assets/images/hero-section.jpg')] bg-gray-700 bg-blend-multiply">
            <div className="px-4 mx-auto lg:mx-20 max-w-screen-xl text-center sm:text-center lg:text-left pt-48 pb-32 lg:pt-48 lg:pb-40">
                <h1 className="mb-4 text-4xl font-extrabold tracking-wide leading-tight text-white sm:text-5xl lg:text-6xl lg:w-3/4 xl:w-1/2">
                    Spora: Your Sport Your Arena
                </h1>
                ...
                <div className="flex flex-col sm:flex-row sm:justify-center lg:justify-start gap-4">
                    ...
                    >
                        Cari Lapangan <ArrowRight className="ml-2" />
                    </Button>
                </div>
            </div>
        </section>
