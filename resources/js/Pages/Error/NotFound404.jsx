    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50 p-6">
            <div className="max-w-2xl w-full bg-white rounded-2xl shadow-lg p-8 md:p-12 text-center">
                <div className="inline-flex items-center justify-center w-24 h-24 rounded-full bg-red-100 mb-6 mx-auto">
                ...
                <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3">
                    <button
                        ...
                        className="px-5 py-3 rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition"
                    >
                        Kembali
                    </button>
                    ...
                    <Link
                        href={dashboardUrl}
                        className="px-5 py-3 rounded-lg bg-red-600 text-white font-medium shadow hover:opacity-95 transition"
                    >
                        Ke Dashboard
                    </Link>
                </div>
