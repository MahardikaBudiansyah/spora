...
export default function Create() {
    ...
    const {
        ...
        displayData,
        submit,
    } = useMerchantBooking(venues, "merchant");
    ...
    return (
        <MerchantLayout>
                ...
                <form onSubmit={(e) => e.preventDefault()}>
                    ...
                    <CardFooter className="p-8 flex justify-end gap-2">
                        <Button
                            ...
                            type="button"
                            onClick={() =>
                                router.get(route("merchant.bookings.index"))
                            }
            ...
            <ConfirmModal
                ...
                description="Pastikan semua data pesanan dan pembayaran sudah benar. Apakah Anda yakin ingin menyimpan booking ini?"
