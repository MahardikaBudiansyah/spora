...
export default function Index() {
    const { merchant, venue, bookings, can_create } = usePage().props;

    const { isOpen, open, close } = useModal();

    return (
        <MerchantLayout>
            <Head title="Semua Order Booking" />
                ...
                <CardBody className="py-4 md:py-6 px-0 min-h-[280px] sm:min-h-[310px] flex flex-col">
                        ...
                        >
                            <div className="flex text-xs">
                                <p>
                                    ...
                                    order booking secara penuh sebelum
                                    verifikasi profil Mitra Anda disetujui oleh
                                    Admin. Silakan lengkapi data profil dan
                    ...
                    <div className="py-2 flex-1 overflow-x-auto">
                        <div className="flex flex-row gap-2 justify-between px-8">
                            ...
                            <div className="flex flex-row gap-2">
                                <Button
                                    variant="primary"
                                    size="xs"
                                    href={route("merchant.bookings.create")}
                                    disabled={!can_create}
                        ...
                        <div className="py-4 px-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2 md:gap-6">
                            <StatCard
                                variant="minimal"
                                title="Total Pesananan"
                                value="1,240 Pesananan"
