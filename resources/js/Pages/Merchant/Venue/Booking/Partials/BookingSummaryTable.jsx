    ...
    return (
        <div className="space-y-8 w-full">
            {dates.map((dateEntry) => {
                ...
                return (
                    <div key={dateEntry?.date || Math.random()} className="p-1">
                        {/* Judul Tanggal */}
                                ...
                                <tbody>
                                            ...
                                            >
                                                {idx === 0 && (
                                                    <td
                                                        ...
                                                        className="border border-secondary-200 dark:border-secondary-600 p-2 align-top font-medium"
                                                    >
                                                        {getFieldName(
                                                            f?.field_id
                                                        )}
                                                ...
                                                {!readOnly && (
                                                    <td className="border border-secondary-200 dark:border-secondary-600 p-2 text-center">
                                                        ...
                                                        >
                                                            <Trash2 className="w-6 h-6 text-red-700 dark:text-red-700 hover:text-red-800 dark:hover:text-red-800 cursor-pointer" />
                                                        </IconButton>
                                                    </td>
                                                )}
                                            </tr>
                                    ...
                                    {showTotal && (
                                        <tr className="bg-gray-100 dark:bg-secondary-700  font-semibold">
                                            ...
                                            {!readOnly && (
                                                <td className="border border-secondary-200 dark:border-secondary-600 p-2" />
                                            )}
                                        </tr>
                                    )}
                                </tbody>
