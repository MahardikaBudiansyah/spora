...
export default function Index() {
    const { venue, membershipOrders } = usePage().props;

    const { isOpen, open, close } = useModal();

    return (
        <MerchantLayout>
            <Head title={`Kelola Order Membership - ${venue.name}`} />
                        ...
                        <div className="flex flex-row gap-2 justify-between px-8">
                            ...
                            <div className="flex flex-row gap-2">
                                <Button
                                    ...
                                    size="xs"
                                    href={route(
                                        "merchant.venues.memberships.orders.create",
                                        {
                                            venue: venue.slug,
                                        },
                                    )}
            ...
            <DevelopmentPlaceholder
                title={`Cetak Data Order Membership ${venue.name}`}
