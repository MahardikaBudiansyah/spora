...
export default function Create() {
    ...
    const {
        ...
        handleStepChange,
        submit,
    } = useMerchantMembershipOrder(venues, "merchant");
    ...
    const onVenueChange = (venueId) => {
        handleVenueChange(venueId, venueOptions);
    };
                        ...
                        <div className="my-12">
                            <Step isActive={currentStep === 0}>
                                <StepMembershipPackageSelection
                                    ...
                                    membershipPackages={availablePackages}
                                    membershipPackageSelection={form.data}
                                    onChangeVenue={onVenueChange}
