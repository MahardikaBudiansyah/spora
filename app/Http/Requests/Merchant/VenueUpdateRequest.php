...
class VenueUpdateRequest extends FormRequest
{
    ...
    {
        return $this->venue && $this->venue->merchant_id === auth('merchant')->id();
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'category_ids.min' => 'Pilih minimal satu kategori venue.',
            'existing_image_ids.required_without' => 'Venue harus memiliki setidaknya satu foto.',
